...
import { fetchOrder, updateOrderStausInStore } from '../../store/checkoutSlice';
...
const MyOrders = () => {
    ...
    useEffect(()=>{
        socket.on("statusUpdated",(data)=>{
            // console.log(data)
            dispatch(updateOrderStausInStore(data))
        })
    },[socket])  
                                        ...
                                        return(
                                            ...
                                            <tr key={order._id}>
                                                ...
                                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                    ...
                                                    <p onClick={()=>navigate(`/myorders/${order._id}`)} className="text-blue-900 underline whitespace-no-wrap">{order._id}</p>
                                                ...
                                                {/* pending ma huda differenet color ya aru condition ma aru color garna milo */}
                                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
