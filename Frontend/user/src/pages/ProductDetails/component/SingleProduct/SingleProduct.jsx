        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          {/* <img alt="ecommerce" className="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src="https://www.whitmorerarebooks.com/pictures/medium/2465.jpg"/> */}
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              {/* Review Stars  and Social Media Icons*/}
              ...
              <p className="leading-relaxed font-bold">Status :{product?.productStatus}</p>
              <p className="leading-relaxed font-bold">Stock Left : {product?.productStockQty }</p>
              <br/>
              ...
              <div className="flex">
...

                {
                  product?.productStockQty > 0 ?(
                    ...
                    <button onClick={handleCart} className="flex px-6 py-2 ml-auto text-white border-0 rounded focus:outline-nonetext-white bg-yellow-500 hover:bg-yellow-600">Add To Cart</button>
                  ):
                  (
                    <button disabled className="flex px-6 py-2 ml-auto text-white border-0 rounded focus:outline-nonetext-white bg-yellow-500 hover:bg-yellow-600">Out Of Stock</button>
