                ...
                <div class="mt-10 flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
                    ...
                    <div class="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                        ...
                        <div class="flex justify-center flex-col md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
                            ...
                            {/* QR */}
                            <div class="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-white-50 dark:bg-white-800 space-y-6">

                                <h1 class="pl-20 text-sm font-extrabold leading-none tracking-tight text-gray-900 md:text-sm lg:text-sm dark:text-white"><mark class="px-3  py-3 text-white bg-blue-600 rounded dark:bg-blue-500">QR Code Of your Order</mark></h1>

                                <QRCode size={200} style={{ maxWidth: "100%", width: "100%" }} value={adminOrderPageUrl}/>
