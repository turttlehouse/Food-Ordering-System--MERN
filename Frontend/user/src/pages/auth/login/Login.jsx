          ...
          <div className="mt-20 bg-white w-17/12 lg:w-5/12 md:6/12 shadow-3xl ">
            ...
            <form onSubmit={handleSubmit} className="p-3 md:p-10">
              ...
              <div className="flex items-center mb-6 text-lg md:mb-8">
                ...
                <input onChange={handleChange} name="email" type="email" id="email" className="w-full py-2 pl-12 bg-gray-200 md:py-4 focus:outline-none" placeholder="Email" />
              ...
              <div className="flex items-center mb-6 text-lg md:mb-8">
                ...
                <input onChange={handleChange} name="password" type="password" id="password" className="w-full py-2 pl-12 bg-gray-200 md:py-4 focus:outline-none" placeholder="Password" />
              ...
              <Link to = "/forgotpassword" className="text-blue-600 underline">Forgot Password ?</Link>
